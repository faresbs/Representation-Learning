...
\begin{figure}
	...
	\caption{Norm of the concatenated average gradients of the loss at the final time step with resepct to the hidden state at each time step(for the best performing models)}
	\label{fig:5_2}
\end{figure}
\item
