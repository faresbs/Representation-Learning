...
\item 
We tried different hyper-parameters for learning rate, number of epochs, network architecture and batch size. We consider the same model architecture.
